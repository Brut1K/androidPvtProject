...
import com.example.nikul.myapplication.homeWork.homeWork6.it_academy.entity.Group;
...
import com.example.nikul.myapplication.homeWork.homeWork6.it_academy.entity.Teacher;
...
import static com.example.nikul.myapplication.homeWork.homeWork6.it_academy.controller.parsers.DateConvert.parseData;
...
public class ParseXML extends Parser{
    ...
    public School parse(Context context){
        ...
        try{
            ...
            dom = builder.parse("school.json.xml");
